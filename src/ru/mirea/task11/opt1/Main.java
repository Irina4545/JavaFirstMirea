...
public class Main extends JFrame {
    ...
    private JLabel label2 = new JLabel("Ввести целое число в текстовое поле");
    private JLabel label3 = new JLabel("Диапазон от 1 до 20, 3 попытки");
    private JPanel panel1 = new JPanel();
    private JPanel panel2 = new JPanel();
    private JTextPane textEditor = new JTextPane();
    private JFrame frame = new JFrame("Игра-угадайка");
